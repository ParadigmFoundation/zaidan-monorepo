...
func main() {
	...
	var (
		...
		makerBind     = fs.String("maker", "0.0.0.0:50051", "The host/port to connect to a maker server over gRPC on")
		hwBind        = fs.String("hw", "0.0.0.0:42001", "The host/port to connect to a hot-wallet server over gRPC on")
		watcherBind   = fs.String("watcher", "0.0.0.0:43001", "The host/port to connect to a watcher server over gRPC on")
